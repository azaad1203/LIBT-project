...
<head>
<title><%=question.getTitle() %> - Brunel Computing</title>
...
<script type="text/javascript">
	validate("validate-login.jsp", "#login-form", "#submit-button");
</script>
</head>
<body>
<div id="container">
...
<%} %>
<hr/>
<a href="view-question.jsp" class="button" style="color:#FFF;">Go Back</a>
</div>
